...
def q1():
    ...
    plt.title(f'Hypothetical NsubK from 0 < k < 200 | Slope: {fit_x_log.slope:.3f}  | Intercept:  {fit_x_log.intercept:.3f}')
...
def q2():
    ...
    plt.xscale('log')
    plt.title('Clustering (C) and Shortest Path Length (L) with Varying Probabilities p')
